...
directory_real = '/Users/srijit/Documents/Projects Personal/FREQUENCY/DM-Net/processed_dct_log_scaled/train/0_real'
directory_fake = '/Users/srijit/Documents/Projects Personal/FREQUENCY/DM-Net/processed_dct_log_scaled/train/1_fake'
...
real_file_paths = get_file_paths(directory_real, '0')  # '1' is the label for real images
fake_file_paths = get_file_paths(directory_fake, '1')  # '0' is the label for fake images
